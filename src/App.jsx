...
const DATA = {
  ...
  finances: {
    totalRaised: 33015.29,
    emailDigital: 0.0,
    smsDigital: 0.0,
    digitalTarget: 0.10,
    byMonth: [
      { month: "2026-03", total: 31848.14, digital: 0.0 },
      { month: "2026-04", total: 1167.15, digital: 0.0 }
    ],
  },

  texting: {
    campaigns: [
      { name: "JG EOQ #2", date: "9/29/25", delivered: 995, clicked: 107, revenue: 0 },
      { name: "251208 Housing not hate", date: "12/8/25", delivered: 6302, clicked: 53, revenue: 0 },
      { name: "02/01/26 to JG", date: "2/1/26", delivered: 8005, clicked: 84, revenue: 0 },
      { name: "JG_EOQ_260331", date: "3/31/26", delivered: 3831, clicked: 34, revenue: 0 }
    ],
    costPerMsg: 0.07,
  },
  ...
  return (
    <div style={{ fontFamily:"Arial,sans-serif", maxWidth:1100, margin:"0 auto", padding:20 }}>
      <h1 style={{ background:"#1F4E79", color:"#fff", padding:"12px 20px", borderRadius:6, marginBottom:16 }}>
        Jimmy Gomez — Digital Dashboard ({DATA.period})
      </h1>
